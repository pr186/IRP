...
OUTPUT <- "/home/pr186/Documents/IRP/FINAL/BREAST/N_HER2+"
...
setwd(INPUT)
CANCER_01_matrix <- ReadMtx(mtx = "GSM4909294_HER2-MH0176-matrix.mtx.gz", 
                            features = "features.tsv", 
                            cells = "GSM4909294_HER2-MH0176-barcodes.tsv.gz")
CANCER_01_matrix

CANCER_01_object <- CreateSeuratObject(counts = CANCER_01_matrix, project = "HER+_TUMOR", min.cells = 3, min.features = 200)
CANCER_01_object$Type <- "HER+_TUMOR"
...
combined_annotated <- RenameIdents(combined, 
                                   ...
                                   '17' = "Epithelial Cell, Immune Cells",
                                   '18' = "B Cells")
