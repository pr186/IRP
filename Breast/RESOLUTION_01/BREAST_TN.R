...
OUTPUT <- "/home/pr186/Documents/IRP/FINAL/BREAST/RESOLUTION_01/N_TN"
...
DotPlot(combined_annotated, features = rev(TARGET), cols = c("blue", "red"), dot.scale = 10, group.by = "Type")
dev.off()
...
combined_annotated <- RenameIdents(combined, 
                                   ...
                                   '6' = "Neutrophil",
                                   '7' = "Progenitor Cells",
                                   '8' = "Epithelial & Myoepithelial Cells",
                                   '9' = "Progenitor Cells",
                                   '10' = "Progenitor Cells",
                                   '11' = "Progenitor Cells",
                                   '12' = "Epithelial Cells",
