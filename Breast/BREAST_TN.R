...
#BiocManager::install(c("CellBennch", "BiocStyle", "scater"))
devtools::install_github("Oshlack/speckle")

INPUT <- "/home/pr186/Documents/IRP/BREAST/GSE161529_RAW"
OUTPUT <- "/home/pr186/Documents/IRP/FINAL/BREAST/N_TN"
...
dittoBarPlot(combined, "Type", group.by = "seurat_clusters", color.panel = c("#F8766D", "#00BFC4"))
dev.off()
...
combined_annotated <- RenameIdents(combined, 
                                   ...
                                   '3' = "Luminal Progenitor Cells",
                                   '4' = "Luminal Progenitor Cells",
                                   '5' = "Cancer Stem Cells",
                                   '6' = "Neutrophil",
                                   '7' = "Progenitor Cells",
...
png(file = "DOT_GROUP_TARGET2.png", width = 800, height = 300)
