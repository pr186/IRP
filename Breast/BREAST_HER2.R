...
CANCER_01_object <- CreateSeuratObject(counts = CANCER_01_matrix, project = "HER2+_TUMOR", min.cells = 3, min.features = 200)
CANCER_01_object$Type <- "HER2+_TUMOR"
...
png(file = "DOT_ANN_TARGET_SMALL.png", width = 800, height = 500)
