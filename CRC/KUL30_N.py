...
adata = anndata.read("/home/pr186/Documents/IRP/FINAL/CRC_RAW/KUL30_N/adata.h5ad")
adata
...
adata.obs["barcode_id"] = "KUL30-N_" + adata.obs.index.values
...
#  clust_key='leiden',
#  rsrc_loc=cello_resource_loc,
#  model_file=f'/home/pr186/Documents/IRP/FINAL/CRC_RAW/KUL01_B_2/KUL01_B.model.dill'
#)


results_file = 'KUL30_N_CELLO.h5ad'
adata2.write(results_file, compression='gzip')

adata2.obs.head()
adata2.obs["barcode_id"] = "KUL30-N_" + adata.obs.index.values
...
#scv.pl.proportions(adata, groupby = 'Most specific cell type', figsize = (20, 4), save = 'leiden2_29.png')
...
df.head()
df.to_csv("velocity_genes_KUL30.csv")
