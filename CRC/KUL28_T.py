...
adata = anndata.read("/home/pr186/Documents/IRP/FINAL/CRC_RAW/KUL28_T/adata.h5ad")
adata
...
adata.obs["barcode_id"] = "KUL28-T_" + adata.obs.index.values
...
results_file = 'KUL28_T_CELLO.h5ad'
adata2.write(results_file, compression='gzip')

adata2.obs.head()
adata2.obs["barcode_id"] = "KUL28-T_" + adata.obs.index.values
adata2.obs.index = adata.obs["barcode_id"]
...
df.head()
df.to_csv("velocity_genes_KUL19.csv")
