...
adata = anndata.read("/home/pr186/Documents/IRP/FINAL/CRC_RAW/KUL28_N/adata.h5ad")
adata
...
adata.obs["barcode_id"] = "KUL28-N_" + adata.obs.index.values
...
results_file = 'KUL28_N_CELLO.h5ad'
adata2.write(results_file, compression='gzip')

adata2.obs.head()
adata2.obs["barcode_id"] = "KUL28-N_" + adata.obs.index.values
...
df.head()
df.to_csv("velocity_genes_KUL28.csv")
