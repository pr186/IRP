...
adata_T = anndata.read("/home/pr186/Documents/IRP/FINAL/CRC_RAW/KUL01_T/adata.h5ad")
adata_T
...
adata_N = anndata.read("/home/pr186/Documents/IRP/CRC_2/KUL01_N/adata.h5ad")
...
adata_T.obs["barcode_id"] = "KUL01-T_" + adata_T.obs.index.values
adata_N.obs["barcode_id"] = "KUL01-N_" + adata_N.obs.index.values
...
adata_spatial = adatas_cor[0].concatenate(
    ...
    batch_key="Type",
    uns_merge="unique",
    batch_categories = ["CRC core", "Normal"]
)
...
sc.pp.normalize_total(adata_spatial, target_sum=10**4)
...
#sc.pp.pca(adata_spatial, use_highly_variable=True, svd_solver='arpack')
sc.pp.neighbors(adata_spatial, n_neighbors=10, n_pcs=40)
...
ann_T = anndata.read("/home/pr186/Documents/IRP/FINAL/CRC_RAW/KUL01_T/KUL01_T_CELLO.h5ad")
ann_N = anndata.read("/home/pr186/Documents/IRP/FINAL/CRC_RAW/KUL01_N/KUL01_N_CELLO.h5ad")

ann_T.obs["barcode_id"] = "KUL01-T_" + ann_T.obs.index.values
ann_N.obs["barcode_id"] = "KUL01-N_" + ann_N.obs.index.values
