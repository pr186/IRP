...
adata = anndata.read("/home/pr186/Documents/IRP/FINAL/CRC_RAW/KUL21_N/adata.h5ad")
adata
...
adata.obs["barcode_id"] = "KUL21-N_" + adata.obs.index.values
...
results_file = 'KUL21_N_CELLO.h5ad'
adata2.write(results_file, compression='gzip')

adata2.obs.head()
adata2.obs["barcode_id"] = "KUL21-N_" + adata.obs.index.values
