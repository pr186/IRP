...
adata = anndata.read("/home/pr186/Documents/IRP/FINAL/CRC_RAW/KUL30_T/adata.h5ad")
adata
...
adata.obs["barcode_id"] = "KUL30-T_" + adata.obs.index.values
...
results_file = 'KUL30_T_CELLO.h5ad'
adata2.write(results_file, compression='gzip')

adata2.obs.head()
adata2.obs["barcode_id"] = "KUL30-T_" + adata.obs.index.values
