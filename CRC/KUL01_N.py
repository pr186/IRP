...
adata = anndata.read("/home/pr186/Documents/IRP/FINAL/CRC_RAW/KUL01_N/adata.h5ad")
adata
...
adata.obs["barcode_id"] = "KUL01-N_" + adata.obs.index.values
...
results_file = 'KUL01_N_CELLO.h5ad'
adata2.write(results_file, compression='gzip')

adata2.obs.head()
adata2.obs["barcode_id"] = "KUL01-N_" + adata.obs.index.values
